...
Currently, only binaries for [Linux](https://github.com/mhausenblas/kubed-sh/releases/download/0.5/kubed-sh-linux) and
[macOS](https://github.com/mhausenblas/kubed-sh/releases/download/0.5/kubed-sh-macos) are provided. Do the following to install `kubed-sh` on your machine.

For Linux:

```
$ curl -s -L https://github.com/mhausenblas/kubed-sh/releases/download/0.5/kubed-sh-linux -o kubed-sh
$ chmod +x kubed-sh
...
```
$ curl -s -L https://github.com/mhausenblas/kubed-sh/releases/download/0.5/kubed-sh-macos -o kubed-sh
$ chmod +x kubed-sh
$ sudo mv kubed-sh /usr/local/bin
```
